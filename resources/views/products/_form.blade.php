...
<div class="grid grid-cols-1 md:grid-cols-3 gap-5">
    ...
    <div>
        ...
        <input type="number" step="0.01" min="0" name="purchase_price" value="{{ old('purchase_price', $p->purchase_price ?? 0) }}" required data-label="Purchase Price" class="w-full border rounded px-3 py-2">
    ...
    <div>
        ...
        <input type="number" step="0.01" min="0" max="100" name="purchase_discount_percent" value="{{ old('purchase_discount_percent', $p->purchase_discount_percent ?? 0) }}" class="w-full border rounded px-3 py-2">
