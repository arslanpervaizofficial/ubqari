...
<div class="bg-white rounded-xl shadow-sm p-5 mb-6">
    ...
    <p class="text-xs text-gray-400 mt-3">
        This page is for actual money spent (Cash Out) only. Putting fresh capital into the business, or recording money owed to someone, now happens on the
        <a href="{{ route('cash-management.index') }}" class="underline">Cash Management</a> page instead.
    </p>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-2">
    ...
    <div class="bg-white p-5 rounded-xl shadow-sm">
        ...
        <div class="text-xs text-gray-400 mt-1">Everything actually spent (Cash Out only)</div>
    </div>
    <div class="bg-white p-5 rounded-xl shadow-sm">
